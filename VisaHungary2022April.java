...
public class VisaHungary2022April {
...
// Не удается получить доступ к сайту
        ...
        baseUrl = "https://visa.vfsglobal.com/blr/ru/hun/book-an-appointment"; // ВЕНГРИЯ
        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
    }

    @Test
    public void testHungApril() throws Exception {

        System.out.println("Ищем даты на ВЕНГРИЮ " + dateNow);
        driver.get(baseUrl);
