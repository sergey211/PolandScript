...
public class PostFromCurl{
    ...
    public static void main(String[] args) throws Exception {
        ...
        URL url = new URL("https://lift-api.vfsglobal.com/user/login");
        HttpURLConnection http = (HttpURLConnection)url.openConnection();
        http.setRequestMethod("POST");
        http.setDoOutput(true);
        http.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");

        String data = "username=kirmaxik@mail.ru&password=!GRUppa104&missioncode=ltu&countrycode=blr";
        ...
        System.out.println("1st post finished");
...
*/
        System.out.println("sending POST 2 appl");


        url = new URL("https://lift-api.vfsglobal.com/appointment/application");
        ...
        data = "{\"countryCode\":\"blr\",\"missionCode\":\"ltu\",\"loginUser\":\"kirmaxik@mail.ru\"}";
        ...
        System.out.println("finished application post");
        // Payload Form Data
/*
